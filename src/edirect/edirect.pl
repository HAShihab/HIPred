...
Sequence Filters
  ...
  -organism    animal, archaea, bacteria, eukaryote, fungi,
               human, insect, mammal, plant, prokaryote,
               protist, rodent, virus
...
sub efilt {
  ...
  $query = process_extras ( $query, $pub, $feature, $location, $molecule, $organism, $source );
